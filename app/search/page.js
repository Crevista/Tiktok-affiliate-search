  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-[#0B0219] min-h-screen">
      ...
      {results.length > 0 ? (
        ...
        isLoading ? (
          <div className="bg-[#0D0225] rounded-lg shadow border border-[#1B7BFF]/30 p-8 text-center">
            <div className="animate-spin h-8 w-8 border-4 border-[#1B7BFF] border-t-transparent rounded-full mx-auto mb-
